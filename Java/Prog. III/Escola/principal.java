    ...
    public static void main (String[] args) throws IOException{
        ...
        do {
            opcao = Integer.parseInt(JOptionPane.showInputDialog(null, new Object[]{
                ...
                "5 - Sobre",
                "6 - Sair"}, "Relatorio v1.1",
                JOptionPane.INFORMATION_MESSAGE /*, new ImageIcon("images/meuIcone.png")*/));
                    ...
                    try{
                        do{
                            ...
                            if(p1.nome.equalsIgnoreCase("fim")){
                                ...
                                String[] genero = {"Masculino", "Feminino", "Não-binarie", "Outros", "Prefiro não informar"};
