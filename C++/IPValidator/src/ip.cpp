...
int main()
{
    char ip1[] = "192.256.0.25";
    char ip2[] = "192.256.0.25";
    char ip3[] = "11111111.00000000.10101010.48";
    char ip4[] = "172.-2.45.6";
    char ip5[] = "10.16.48.24";
    char ip6[] = "192.168.20.30.1";
    is_valid_ip(ip1) ? cout<<"Valid\n" : cout<<"Not valid\n";
    is_valid_ip(ip2) ? cout<<"Valid\n" : cout<<"Not valid\n";
    is_valid_ip(ip3) ? cout<<"Valid\n" : cout<<"Not valid\n";
    is_valid_ip(ip4) ? cout<<"Valid\n" : cout<<"Not valid\n";
    is_valid_ip(ip5) ? cout<<"Valid\n" : cout<<"Not valid\n";
    is_valid_ip(ip6) ? cout<<"Valid\n" : cout<<"Not valid\n";
    return 0;
}
